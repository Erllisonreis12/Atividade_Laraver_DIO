...
<body>
    <header class="logo">
        <nav class="navbar navbar-expand-lg">
            <div class="container">
                <a class="navbar-brand" href="{{route('home_cidadao')}}">
                    <img src="https://semsa.manaus.am.gov.br/wp-content/themes/semsa/dist/imagens/2021/logo-pmm-2021.png"  class="img-fluid">
                </a>
    ...
    <footer class="justify-content-center fixed-bottom">
